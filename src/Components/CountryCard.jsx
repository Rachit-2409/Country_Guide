...
const CountryCard = () => {
  ...
  return (
    CountryDetail &&
    <div className='h-[80vh] w-[100%] flex justify-center items-center flex-col lg:flex-row mt-6 mx-auto'>
      <div className='p-5'>
      ...
      <div className='text-left p-5'>
        ...
        <p>
          Currency:{" "}
          {Object.keys(CountryDetail?.currencies || {}).map((code) => {
